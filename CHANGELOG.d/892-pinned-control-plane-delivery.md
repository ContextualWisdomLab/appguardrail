...
- Reject ambiguous control-plane base URLs and validate receipt identifiers and deploy-blocking counts before rendering terminal output, preventing query/fragment confusion and forged control-sequence messages.
