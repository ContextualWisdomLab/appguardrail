...
- Added a migration rehearsal guide and documented the separate application-integration phase required before production startup invokes the migration. It is not a production backup/restore runbook; deployed recovery ownership, commands, RTO/RPO, and rehearsal evidence remain required.
