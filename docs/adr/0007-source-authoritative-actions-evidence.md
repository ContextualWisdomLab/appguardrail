...
3. reject redirects, non-JSON responses, responses larger than 2 MiB, and non-object JSON;
...
- true-positive, true-negative, cancelled, malformed, stale, future, duplicate, wrong-origin, wrong-identity, oversized, invalid JSON, unfinished, and token-disclosure tests;
