...
|---|---|---|---|
| [ADR-0001](ADR-0001-issue-complete-detection-contract.md) | Accepted | Every AppGuardrail issue is a no-exclusion executable detector requirement. | `ACTIVE_PR` #911 |
