...
**Action:** Use a single `for` loop with early returns and O(1) object lookups for sorting priorities to minimize execution passes, ensuring exact behavioral parity for missing keys.
