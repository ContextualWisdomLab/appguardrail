...
## 2024-07-24 - Table Row aria-label overriding
**Learning:** Setting aria-label on table rows overrides natural table cell reading and hides critical table data from screen reader users.
