...
## 2024-08-14 - External link context switch warning
**Learning:** Screen readers need explicit warning when a link opens in a new tab.
**Action:** Always add an aria-label with '(opens in a new tab)' for links with target="_blank".
