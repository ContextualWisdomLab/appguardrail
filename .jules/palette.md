...
## 2024-05-19 - Avoid aria-label on table rows
**Learning:** Using `aria-label` on `<tr>` elements (even those with `role="button"`) overrides natural table cell reading and hides critical table data from screen reader users.
