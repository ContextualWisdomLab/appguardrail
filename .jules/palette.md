...
## 2026-07-23 - Async feedback and live regions
**Learning:** Screen readers miss dynamic error messages, and users experience uncertainty without loading states during API calls in the console.
**Action:** Add `aria-live="polite"` to message containers and implement visual button loading states (`disabled`, opacity changes) during fetch operations.
