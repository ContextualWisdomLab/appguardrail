...
## 2024-05-31 - External links accessibility
**Learning:** When using target="_blank" for external links, screen reader users miss the visual cue of a new tab opening.
**Action:** Add `(opens in a new tab)` to the `aria-label` or visually hidden text for external links.
