...
## 2026-08-15 - Context Switch Accessibility for External Links
**Learning:** External links with `target="_blank"` open in a new tab, causing an unexpected context switch for screen reader users if not explicitly announced.
