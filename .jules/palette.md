...
## 2024-10-24 - Accessibility warning for external links
**Learning:** When using target="_blank" for external links, it is a good accessibility practice to warn screen reader users of the context switch.
**Action:** Add aria-label="[Link text] (opens in a new tab)" to external links.
