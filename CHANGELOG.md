...
### 보안
- #1268과 #1271의 webhook SSRF 중복 구현을 단순 Close가 아닌 #1217 exact head `43bc6ba…`의 verified complete successor carryover로 정리했습니다. Direct persistence/API admission, empty-host·malformed URL·DNS-rebinding 경계, explicit clear semantics, focused 119/119와 full 1,029/1,029, 그리고 #1099 RCA가 모든 유효 요구사항을 보존하며 #1217의 queued exact-head Checks와 독립 승인은 그대로 merge gate로 남습니다.
