...
### 보안
- Control-plane console severity colors now accept only own properties of the fixed severity map; inherited names such as `constructor`, `toString`, and `__proto__` fall back to the INFO color while the displayed severity remains escaped.
