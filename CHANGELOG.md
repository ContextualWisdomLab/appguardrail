...
- Gap baseline에 #1324의 동시 Python detector 회귀 복구를 결속했습니다. Concurrent `bdef14c0…`는 dynamic `shell=enabled`를 놓치고 UTF-8 앞 call의 exact offset 대신 line start를 보고하며 56줄 regression과 CHANGELOG를 삭제했습니다. RED positive 5/6·UTF-8 offset false 뒤 ordinary exact `d8e5af78…`가 verified tree를 복원해 focused positive 6/6, negative 0, offset/fallback/compile GREEN입니다. Workflow 9개 queued, 승인 0개라 Draft입니다.
