...
def _collect_files(base_path: Path):
    """Collect all scannable files, skipping unwanted directories and symlinks."""
    # SECURITY: Prevent Arbitrary File Read / Path Traversal by explicitly avoiding symlinks
    stack = [base_path]
    while stack:
