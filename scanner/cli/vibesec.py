...
def _collect_files(base_path: Path):
    ...
    # ⚡ Bolt Optimization: os.scandir is significantly faster than os.walk + Path operations
    # because it caches file attributes (like is_dir/is_file) and reduces stat() syscalls.
    stack = [base_path]
    while stack:
