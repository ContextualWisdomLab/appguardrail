...
def _collect_files(base_path: Path):
    ...
    ⚡ Bolt Optimization: Replaced os.walk with os.scandir to avoid redundant stat()
    calls and delay Path object creation, significantly speeding up directory traversal.
    """
    stack = [base_path]
    while stack:
            ...
            with os.scandir(current_dir) as entries:
                for entry in entries:
                    ...
                    if entry.is_dir(follow_symlinks=False):
                        ...
                        # Avoid creating Path object just to get suffix
