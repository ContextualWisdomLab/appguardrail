...
def _collect_files(base_path: Path):
    ...
    # ⚡ Bolt: Optimize file traversal using os.scandir and fast string methods
    # This avoids expensive stat() calls by using cached directory attributes
    # and defers Path object creation until a valid file is found. We use
    # str.rfind() instead of os.path.splitext to avoid parser overhead in hot loops.
